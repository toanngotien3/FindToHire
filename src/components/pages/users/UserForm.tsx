        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 flex flex-col justify-center items-center">
            ...
            <div className='w-full'>
                ...
                <textarea
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                />
                {errors.detail && <p className="mt-2 text-sm text-red-500">{errors.detail.message}</p>}
            </div>
            ...
            <div className='w-full'>
                ...
                <input
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                />
                {errors.tg && <p className="mt-2 text-sm text-red-500">{errors.tg.message}</p>}
            </div>
            ...
            <div className='w-full'>
                ...
                <input
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                />
                {errors.x && <p className="mt-2 text-sm text-red-500">{errors.x.message}</p>}
            </div>
            ...
            <div className='w-full'>
                ...
                <input
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                />
                {errors.site && <p className="mt-2 text-sm text-red-500">{errors.site.message}</p>}
            </div>
            ...
            <div className='w-full'>
                ...
                <input
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                />
                {errors.exp && <p className="mt-2 text-sm text-red-500">{errors.exp.message}</p>}
            </div>
